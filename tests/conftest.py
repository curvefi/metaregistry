...
def pytest_sessionstart(session):
    ...
    ape_runner.network_manager.active_provider = (
        ape_runner.network_manager.get_provider_from_choice(ape_runner._network_choice)
    )
    ...
    ALL_POOLS = (
        STABLE_REGISTRY_POOLS + STABLE_FACTORY_POOLS + CRYPTO_REGISTRY_POOLS + CRYPTO_FACTORY_POOLS
    )
