...
def test_stable_factory_pools(populated_metaregistry, stable_factory_pool, stable_factory):
    metaregistry_output = populated_metaregistry.get_pool_asset_type(stable_factory_pool)
    if stable_factory_pool in EXCEPTIONS:
        metaregistry_output = EXCEPTIONS[stable_factory_pool]
    assert metaregistry_output == stable_factory.get_pool_asset_type(stable_factory_pool)
